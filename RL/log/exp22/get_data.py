...
# d2 = np.array([])
#
# sns.kdeplot(d2, label='end-end from 7m', shade=True)
# sns.kdeplot(d1, label='set-down from 1m', shade=True)
...
cur1 = pd.read_json('following_23.4.4_log.csv')['episode_reward']
cur2 = pd.read_json('following_23.4.4_log.csv')['mean_q']
