...
def main():
	...
	hdqn_agent = HQNAgent(
		...
		controller_dir='controller_source_110k_5763eps.weight',
		meta_controller_dir='metacontroller_target_110k_5763eps.weight'
	)

	hdqn_agent.fit(env, env, NUM_EPISODES, EVAL_NUM_EPISODES)
	# hdqn_agent.evaluate(env, EVAL_NUM_EPISODES)
